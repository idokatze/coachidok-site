<template>
    <section class="section section-topless about-preview-section">
        <div class="container about-preview-layout">
            ...
            <div class="about-preview-image-wrap">
                <img
                    :src="coachPortrait"
                    ...
                    decoding="async"
                    loading="lazy"
                    sizes="(max-width: 760px) 92vw, 384px"
                    width="1200"
                    height="1200"
                />
            </div>
...
<style scoped>
    ...
    .about-preview-keywords li::before {
        content: '';
        inline-size: 1.15rem;
        block-size: 2px;
        border-radius: 999px;
